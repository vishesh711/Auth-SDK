...
"""
from sqlalchemy import Column, String, DateTime, Boolean, ForeignKey, UniqueConstraint, func
...
class User(Base):
    ...
    user_metadata = Column("metadata", JSONB)  # Column name is "metadata" in DB
    ...
    __table_args__ = (
        UniqueConstraint("app_id", "email", name="uq_users_app_email"),
    )
